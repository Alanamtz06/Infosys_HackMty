...
class PendingOrder:
    ...
    def to_dict(self) -> dict:
        return {"order": self.order, "evaluation": _evaluation_to_dict(self.evaluation)}

    @classmethod
    def from_dict(cls, data: dict) -> PendingOrder:
        return cls(order=data["order"], evaluation=_evaluation_from_dict(data["evaluation"]))
...
class SessionState:
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "god_mode_preset": self.god_mode_preset,
            ...
            "active_closure": self.active_closure,
    ...
    def from_dict(cls, data: dict) -> SessionState:
        ...
        return cls(
            ...
            hour_override=data.get("hour_override"),
            god_mode_preset=data.get("god_mode_preset"),
            ...
            active_closure=data.get("active_closure"),
